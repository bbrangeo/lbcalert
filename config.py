...
class Config(object):
    ...
    PROXIES = ['http://elitesurfingproxy.appspot.com/','http://unblockwebsitesproxy.appspot.com']
    # 'http://bestsurfing1.appspot.com/','http://getwebaddress.appspot.com/','https://techbum-server.appspot.com/','http://proxy-4-web.appspot.com','http://unlimit-proxy.appspot.com/','http://browsewebfastly.appspot.com/','http://trickseek-proxyserver.appspot.com'
